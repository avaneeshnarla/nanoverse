...
public class ContinuumHillLinProbabilitySupplierFactoryHelper {

    public ContinuumHillLinProbabilitySupplierDescriptor build(String layer,
                                                               String
                                                                       substrate, double
            coefficient, double offset, double halfpoint, double maximum,
                                                            LayerManager
                                                                    layerManager) {
        return new ContinuumHillLinProbabilitySupplierDescriptor(layer,
