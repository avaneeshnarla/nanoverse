...
import nanoverse.compiler.pipeline.instantiate.factory.agent.action.MakeTwoFactory;
 ...
 */
public class MakeTwoLoader extends ActionLoader<MakeTwoDescriptor> {

    private final MakeTwoFactory factory;
    private final MakeTwoInterpolator interpolator;

    public MakeTwoLoader() {
        factory = new MakeTwoFactory();
        interpolator = new MakeTwoInterpolator();
    }

    public MakeTwoLoader(MakeTwoFactory factory,
                      MakeTwoInterpolator interpolator) {
    ...
    @Override
    public MakeTwoDescriptor instantiate(MapObjectNode node, LayerManager lm, GeneralParameters p) {
