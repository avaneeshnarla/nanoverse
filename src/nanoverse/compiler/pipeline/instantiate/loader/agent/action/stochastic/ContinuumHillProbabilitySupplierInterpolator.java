 ...
 */
public class ContinuumHillProbabilitySupplierInterpolator {

    private final LoadHelper load;

    public ContinuumHillProbabilitySupplierInterpolator() {
        load = new LoadHelper();
    }

    public ContinuumHillProbabilitySupplierInterpolator(LoadHelper load) {
        this.load = load;
    }
