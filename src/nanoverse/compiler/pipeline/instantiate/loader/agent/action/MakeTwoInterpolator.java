 ...
 */
public class MakeTwoInterpolator {
    private final LoadHelper load;
    private final MakeTwoDefaults defaults;

    public MakeTwoInterpolator() {
        load = new LoadHelper();
        defaults = new MakeTwoDefaults();
    }

    public MakeTwoInterpolator(LoadHelper load, MakeTwoDefaults defaults) {
        this.load = load;
